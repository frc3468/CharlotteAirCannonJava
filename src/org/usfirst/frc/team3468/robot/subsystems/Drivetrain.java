...
public class Drivetrain extends Subsystem {
	...
	Talon rearLeftMotor = new Talon(RobotMap.rearLeftDrivetrainMotor);
	Talon frontLeftMotor = new Talon(RobotMap.frontLeftDrivetrainMotor);
	SpeedControllerGroup leftMotors = new SpeedControllerGroup(rearLeftMotor, frontLeftMotor);
	
	Talon rearRightMotor = new Talon(RobotMap.rearRightDrivetrainMotor);
	Talon frontRightMotor = new Talon(RobotMap.frontRightDrivetrainMotor);
